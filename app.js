(function() {
	...
	app.config(function($stateProvider, $urlRouterProvider, $controllerProvider){
		...
		$stateProvider
			...
			.state('players',{
	        url:'/players',
	        templateUrl: viewsPrefix + 'players.html',
	        controller:'PlayerListController'
	    }).state('viewPlayer',{
	       url:'/players/:id/view',
	       templateUrl: viewsPrefix + 'player-view.html',
	       controller:'PlayerViewController'
	    }).state('newPlayer',{
	        url:'/players/new',
	        templateUrl: viewsPrefix + 'player-add.html',
	        controller:'PlayerCreateController'
	    }).state('editPlayer',{
	        url:'/players/:id/edit',
	        templateUrl: viewsPrefix + 'player-edit.html',
